...
function injectGlobalComponents() {
    ...
    const headerHTML = `
        <div class="container flex justify-between align-center">
            ...
            <div class="social-icons" style="display: flex; align-items: center;">
                <a href="https://scholar.google.com/citations?user=ikuM7LUAAAAJ&hl=en" title="Google Scholar" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.linkedin.com/in/kiran-k-kethineni" title="LinkedIn" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
                <a href="https://github.com/kirankkethineni/" title="GitHub" target="_blank" rel="noopener noreferrer">
    ...
    // Navigation Injection - CLEARED (Merged into header)
    const navHTML = ``;
        ...
        <div class="container">
            <div class="flex justify-between align-center footer-inner">
                <div class="social-links">
                    <a href="https://scholar.google.com/citations?user=ikuM7LUAAAAJ&hl=en" target="_blank" rel="noopener noreferrer">Google Scholar</a>
                    <a href="https://www.linkedin.com/in/kiran-k-kethineni" target="_blank" rel="noopener noreferrer">LinkedIn</a>
                    <a href="https://github.com/kirankkethineni/" target="_blank" rel="noopener noreferrer">GitHub</a>
    ...
    if (navEl) {
        ...
        navEl.style.display = 'none'; // Hide the container
    }
...
function updateActiveNavLink() {
    ...
    // Update selector to find links in the new header navigation
